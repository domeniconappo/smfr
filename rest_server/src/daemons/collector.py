...
class Collector:
    ...
    def hashedid(self):
        return hash(
            '{o.config}{o.nuts2source}{o.nuts2}{o.runtime}{o.ctype}{o.trigger}{o.forecast_id}{o.kwfile}{o.locfile}'
            .format(o=self)
        )
    ...
    def from_payload(cls, payload, user=None):
        ...
        for paramkey, filekey in (('keywords', 'kwfile'), ('configuration', 'config'), ('bounding_boxes', 'locfile')):
            if not payload.get(paramkey):
                del payload[paramkey]
                if filekey == 'locfile':
                    continue
                payload[filekey] = Collector.defaults[filekey]
                continue
        ...
        collector = cls(config_file=payload['config'], keywords_file=payload.get('kwfile'),
    ...
    def resume_all(cls):
        ...
        """
        stored_collectors = StoredCollector.query.join(TwitterCollection,
                                                       StoredCollector.collection_id == TwitterCollection.id)
